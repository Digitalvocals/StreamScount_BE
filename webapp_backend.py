...
GENRE_CATEGORIES = {
    ...
    "Racing": ["Racing"],
    "Indie": ["Indie"],
    "Action": ["Action", "Hack and slash/Beat 'em up", "Arcade"],
    "Card Game": ["Card & Board Game", "Card Game", "Card Battle"],
    "MMO": ["MMORPG", "Massively Multiplayer Online (MMO)"],
    "Sandbox": ["Sandbox"],
...
def get_available_genres():
    """Get list of available genre filters"""
    # Return our standard genre categories
    genres = sorted(GENRE_CATEGORIES.keys())
    return jsonify({
        "genres": genres,
        "total": len(genres)
    })
